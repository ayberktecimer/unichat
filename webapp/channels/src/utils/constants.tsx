...
defineMessages({
    ...
    socketError: {
        ...
        defaultMessage: 'Please check connection, Cirql Chat unreachable. If issue persists, ask administrator to [check WebSocket port](!https://docs.cirql.chat/install/troubleshooting.html#please-check-connection-mattermost-unreachable-if-issue-persists-ask-administrator-to-check-websocket-port).',
    },
...
export const AboutLinks = {
    TERMS_OF_SERVICE: 'https://cirql.chat/pl/terms-of-use/',
    PRIVACY_POLICY: 'https://cirql.chat/pl/privacy-policy/',
};

export const CloudLinks = {
    BILLING_DOCS: 'https://docs.cirql.chat/pl/cloud-billing',
    PRICING: 'https://cirql.chat/pl/pricing/',
    PRORATED_PAYMENT: 'https://cirql.chat/pl/cirqlchat-cloud-prorate-documentation',
    DEPLOYMENT_OPTIONS: 'https://cirql.chat/deploy/',
    DOWNLOAD_UPDATE: 'https://cirql.chat/deploy/',
    CLOUD_SIGNUP_PAGE: 'https://cirql.chat/sign-up/',
    SELF_HOSTED_SIGNUP: 'https://customers.cirql.chat/signup',
    DELINQUENCY_DOCS: 'https://docs.cirql.chat/about/cloud-subscriptions.html#failed-or-late-payments',
    SELF_HOSTED_PRICING: 'https://cirql.chat/pl/pricing/#self-hosted',
};

export const HostedCustomerLinks = {
    BILLING_DOCS: 'https://cirql.chat/pl/how-self-hosted-billing-works',
    SELF_HOSTED_BILLING: 'https://cirql.chat/pl/self-hosted-billing',
    TERMS_AND_CONDITIONS: 'https://cirql.chat/enterprise-edition-terms/',
    SECURITY_UPDATES: 'https://cirql.chat/security-updates/',
    DOWNLOAD: 'https://cirql.chat/download',
    NEWSLETTER_UNSUBSCRIBE_LINK: 'https://forms.cirql.chat/UnsubscribePage.html',
    PRIVACY: AboutLinks.PRIVACY_POLICY,
};

export const DocLinks = {
    ABOUT_TEAMS: 'https://docs.cirql.chat/welcome/about-teams.html#team-url',
    ADVANCED_LOGGING: 'https://cirql.chat/pl/advanced-logging',
    CONFIGURE_DOCUMENT_CONTENT_SEARCH: 'https://cirql.chat/pl/configure-document-content-search',
    CONFIGURE_AD_LDAP_QUERY_TIMEOUT: 'https://cirql.chat/pl/configure-ad-ldap-query-timeout',
    CONFIGURE_OVERRIDE_SAML_BIND_DATA_WITH_LDAP: 'https://cirql.chat/pl/configure-override-saml-bind-data-with-ldap',
    COMPILANCE_EXPORT: 'https://cirql.chat/pl/compliance-export',
    COMPILANCE_MONITORING: 'https://cirql.chat/pl/compliance-monitoring',
    DATA_RETENTION_POLICY: 'https://cirql.chat/pl/data-retention-policy',
    DEFAULT_LDAP_GROUP_SYNC: 'https://cirql.chat/pl/default-ldap-group-sync',
    DESKTOP_MANAGED_RESOURCES: 'https://cirql.chat/pl/desktop-managed-resources',
    ELASTICSEARCH: 'https://cirql.chat/pl/setup-elasticsearch',
    ENABLE_CLIENT_SIDE_CERTIFICATION: 'https://cirql.chat/pl/enable-client-side-certification',
    ENABLE_HARDENED_MODE: 'https://cirql.chat/pl/enable-hardened-mode',
    FORMAT_MESSAGES: 'https://cirql.chat/pl/format-messages',
    FILE_STORAGE: 'https://cirql.chat/pl/configure-file-storage',
    GUEST_ACCOUNTS: 'https://docs.cirql.chat/onboard/guest-accounts.html',
    HIGH_AVAILABILITY_CLUSTER: 'https://cirql.chat/pl/high-availability-cluster',
    IN_PRODUCT_NOTICES: 'https://cirql.chat/pl/in-product-notices',
    MULTI_FACTOR_AUTH: 'https://cirql.chat/pl/multi-factor-authentication',
    ONBOARD_ADVANCED_PERMISSIONS: 'https://cirql.chat/pl/advanced-permissions',
    ONBOARD_LDAP: 'https://cirql.chat/pl/setup-ldap',
    SELF_HOSTED_BILLING: HostedCustomerLinks.SELF_HOSTED_BILLING,
    SESSION_LENGTHS: 'https://cirql.chat/pl/configure-session-lengths',
    SETUP_IMAGE_PROXY: 'https://cirql.chat/pl/setup-image-proxy',
    SETUP_LDAP: 'https://cirql.chat/pl/setup-ldap',
    SETUP_PERFORMANCE_MONITORING: 'https://cirql.chat/pl/setup-performance-monitoring',
    SETUP_PUSH_NOTIFICATIONS: 'https://cirql.chat/pl/setup-push-notifications',
    SETUP_SAML: 'https://docs.cirql.chat/pl/setup-saml',
    SHARE_LINKS_TO_MESSAGES: 'https://cirql.chat/pl/share-links-to-messages',
    SITE_URL: 'https://cirql.chat/pl/configure-site-url',
    SSL_CERTIFICATE: 'https://cirql.chat/pl/setup-ssl-client-certificate',
    TRUE_UP_REVIEW: 'https://cirql.chat/pl/true-up-documentation',
    TRUSTED_CONNECTION: 'https://cirql.chat/pl/default-allow-untrusted-internal-connections',
    UPGRADE_SERVER: 'https://cirql.chat/pl/upgrade-cirqlchat',
};

export const DeveloperLinks = {
    CUSTOM_SLASH_COMMANDS: 'https://cirql.chat/pl/custom-slash-commands',
    ENABLE_OAUTH2: 'https://cirql.chat/pl/enable-oauth',
    INCOMING_WEBHOOKS: 'https://cirql.chat/pl/incoming-webhooks',
    OUTGOING_WEBHOOKS: 'https://cirql.chat/pl/outgoing-webhooks',
    INTERACTIVE_MESSAGES: 'https://cirql.chat/pl/interactive-messages',
    INTERACTIVE_DIALOGS: 'https://cirql.chat/pl/interactive-dialogs',
    PERSONAL_ACCESS_TOKENS: 'https://cirql.chat/pl/personal-access-tokens',
    PLUGIN_SIGNING: 'https://cirql.chat/pl/sign-plugins',
    PLUGINS: 'https://cirql.chat/pl/plugins',
    SETUP_CUSTOM_SLASH_COMMANDS: 'https://cirql.chat/pl/setup-custom-slash-commands',
    SETUP_INCOMING_WEBHOOKS: 'https://cirql.chat/pl/setup-incoming-webhooks',
    SETUP_OAUTH2: 'https://cirql.chat/pl/setup-oauth-2.0',
    SETUP_OUTGOING_WEBHOOKS: 'https://cirql.chat/pl/setup-outgoing-webhooks',
};

export const LicenseLinks = {
    CONTACT_SALES: 'https://cirql.chat/contact-sales/',
    TRIAL_INFO_LINK: 'https://cirql.chat/trial',
    EMBARGOED_COUNTRIES: 'https://cirql.chat/pl/limitations-for-embargoed-countries',
    SOFTWARE_SERVICES_LICENSE_AGREEMENT: 'https://cirql.chat/pl/software-and-services-license-agreement',
    SOFTWARE_SERVICES_LICENSE_AGREEMENT_TEXT: 'Software Services and License Agreement',
    UNSUPPORTED: 'https://cirql.chat/pricing/',
};

export const MattermostLink = 'https://cirql.chat/';
...
export const Constants = {
    ...
    MHPNS_US: 'https://push.cirql.chat',
    MHPNS_DE: 'https://hpns-de.cirql.chat',
    MTPNS: 'https://push-test.cirql.chat',
    MAX_PREV_MSGS: 100,
